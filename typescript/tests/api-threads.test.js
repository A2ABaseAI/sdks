...
const threads_1 = require("../src/api/threads");
describe('ThreadsClient', () => {
    ...
    beforeEach(() => {
        ...
        client = new threads_1.ThreadsClient(mockApiClient);
    });
    describe('getThreads', () => {
    ...
    describe('createThread', () => {
        it('should create thread with name', async () => {
            ...
            expect(mockApiClient.post).toHaveBeenCalledWith('/threads', 'name=Test+Thread', undefined);
            expect(result).toEqual(mockResponse);
        });
